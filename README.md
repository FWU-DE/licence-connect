...
The github of the Bildungslogin public API can be found under https://github.com/BILDUNGSLOGIN/public_api_docs and is licenced with https://github.com/BILDUNGSLOGIN/public_api_docs/blob/main/LICENSE.txt .
